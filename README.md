...
本プロジェクトは CPU 実行を前提としています。SD 1.5 は 512×512 で訓練されているため、256×256 では意味のある画像が生成できません。一方、miniSD は 256×256 でも比較的良好な画像が生成できます。AMD Ryzen 5 5600X (WSL2) での生成時間は 256×256 で約 30 秒、512×512 で約 3 分です。サンプル画像は [samples/README.md](samples/README.md) を参照してください。
