ページ：[01](01_quickstart.md) | [02](02_overview.md) | [03](03_clip.md) | **04** | [05](05_groupnorm.md) | [06](06_resblock.md) | [07](07_unet.md) | [08](08_cross_attention.md) | [09](09_ddim.md) | [10](10_vae.md) | [11](11_pipeline.md) | [12](12_lora.md) | [13](13_architecture.md)
...
3×3 カーネルで小さな入力画像を畳み込み、手計算の結果と一致することを確認します。また、PyTorch の `F.conv2d` と数値比較し、im2col 実装の正しさを検証します。手計算の結果 (7, 6, 4, 5) と一致し、PyTorch の `F.conv2d` との誤差もゼロです。複数チャネルや stride=2 のケースでも im2col 実装が正しく動作することが確認できます。stride=2 では空間サイズが 32→16 と半分になっています。
