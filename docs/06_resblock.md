ページ：[01](01_quickstart.md) | [02](02_overview.md) | [03](03_clip.md) | [04](04_conv2d.md) | [05](05_groupnorm.md) | **06** | [07](07_unet.md) | [08](08_cross_attention.md) | [09](09_ddim.md) | [10](10_vae.md) | [11](11_pipeline.md) | [12](12_architecture.md)
...
VaeResBlock と UNetResBlock の動作を確認します。実行結果は以下のとおりです。

```
=== 1. VaeResBlock (512 → 512) ===
入力:  (512, 4, 4)
出力:  (512, 4, 4)
残差の平均絶対値: 0.3590

=== 2. VaeResBlock (512 → 256) ===
入力:  (512, 8, 8)
出力:  (256, 8, 8) (1×1 conv でチャネル数を変換)

=== 3. タイムステップ埋め込み ===
t=900 の埋め込み: shape=(1280,), mean=-0.0064
t=100 の埋め込み: shape=(1280,), mean=0.0035
t=900 と t=100 のコサイン類似度: -0.6039

=== 4. UNetResBlock (320 → 320) ===
入力:  (320, 32, 32)
temb:  (1280,)
出力:  (320, 32, 32)
```

VaeResBlock (512→512) では入出力が同じ形状で、残差の平均絶対値 0.3590 は「入力に対する小さな修正」であることを示しています。VaeResBlock (512→256) ではチャネル数が変わるため、1×1 conv によるショートカットが使われます。
