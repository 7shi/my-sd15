ページ：[01](01_quickstart.md) | [02](02_overview.md) | [03](03_clip.md) | [04](04_conv2d.md) | [05](05_groupnorm.md) | [06](06_resblock.md) | [07](07_unet.md) | [08](08_cross_attention.md) | [09](09_ddim.md) | **10** | [11](11_pipeline.md) | [12](12_architecture.md)
...
潜在表現から画像への変換を追跡し、各段階のテンソル形状とパラメータ数を確認します。実行結果は以下のとおりです。
...
=== 3. パラメータ数 ===
VAE Decoder 総パラメータ: 83,653,863 (84M)

=== 4. スケーリング係数の効果 ===
スケーリングあり: mean=-0.1022, std=0.7491
スケーリングなし: mean=-0.1563, std=0.1075
スケーリングにより入力の振幅が 5.5 倍に拡大

=== 5. 画像への変換 ===
PIL Image: size=(256, 256), mode=RGB
値の範囲: decoded [-1.95, 1.63] → pixel [0, 255]
```

196,608 要素のピクセル空間が 4,096 要素の潜在空間に 48 倍圧縮されています。スケーリング係数の効果（実験 4）を見ると、0.18215 で割ることで入力の標準偏差が 0.1075 から 0.7491 に拡大されます。VAE は学習時にこの振幅を前提としているため、スケーリングを忘れると正しい画像が得られません。
