ページ：[01](01_quickstart.md) | [02](02_overview.md) | [03](03_clip.md) | [04](04_conv2d.md) | [05](05_groupnorm.md) | [06](06_resblock.md) | [07](07_unet.md) | [08](08_cross_attention.md) | [09](09_ddim.md) | [10](10_vae.md) | [11](11_pipeline.md) | [12](12_lora.md) | **13**
...
| 重みの適応 | — | [LoRA](12_lora.md)（低ランク分解で少量パラメータの追加） |
...
### 一貫性モデル (Consistency Models) / LCM

拡散モデルの「多ステップ」という制約を取り除き、1〜2 ステップで画像を生成する手法。DDIM の「決定的な軌跡」の考え方を発展させています。[12 章](12_lora.md)で実装した LCM LoRA は、この一貫性モデルの考え方を LoRA として既存モデルに適用したもので、U-Net 全層への LoRA 適用と専用スケジューラーの組み合わせにより 2 ステップでの生成を実現しています。

これらの発展はいずれも、SD 1.5 で学んだ概念（Attention、残差接続、潜在空間、CFG、LoRA）の延長線上にあります。SD 1.5 の理解は、最新の画像生成モデルを学ぶ確かな土台になるはずです。
