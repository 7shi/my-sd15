...
Latent 列と VAE デコード列を比較すると、Latent の構造が画像の構造とある程度対応していることが観察されます。Latent の 4 成分は色とは対応しない情報を持っていますが、可視化のため仮に色を割り当てており、色合いは便宜的なものです。VAE Decoder は学習済みの知識を使って潜在表現をピクセル空間に復元します。
